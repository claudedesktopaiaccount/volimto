...
4. **Create artifacts in sequence until apply-ready**
   ...
   Use the available task plan/checklist mechanism to track progress through the artifacts.
...
- Prompt: "Ask me to implement, or use `openspec-apply-change`, to start working on the tasks."
